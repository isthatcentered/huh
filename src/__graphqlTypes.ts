...
export type PostLinkFragmentFragment = {
  __typename?: "MarkdownRemarkConnection"
} & {
  edges: Array<
    { __typename?: "MarkdownRemarkEdge" } & {
      node: { __typename?: "MarkdownRemark" } & {
        ...
        headings: Maybe<
          Array<
            Maybe<
              { __typename?: "MarkdownHeading" } & Pick<
                MarkdownHeading,
                "value" | "depth"
              >
            >
...
export type PostsListQueryVariables = {
  max: Maybe<Scalars["Int"]>
}

export type PostsListQuery = { __typename?: "Query" } & {
  allMarkdownRemark: Maybe<
    { __typename?: "MarkdownRemarkConnection" } & PostLinkFragmentFragment
  >
}
